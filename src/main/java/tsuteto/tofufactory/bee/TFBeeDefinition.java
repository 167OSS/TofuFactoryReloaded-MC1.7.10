...
public class TFBeeDefinition {
    ...
    public static void setupBeeSpecies() {
        ...
        KINU.addProduct(new ItemStack(TcItems.tofuKinu, 4), 0.8F)
        ...
        MOMEN.addProduct(new ItemStack(TcItems.tofuMomen, 4), 0.8F)
            .addProduct(new ItemStack(TcItems.tofuIshi, 2), 0.5F)
            .setHumidity(EnumHumidity.DAMP)
            .setIsSecret();
        BeeManager.beeInterface.registerTemplate(TFBeeGenomeManager.getTemplateMomen());

        KONGO.addProduct(new ItemStack(TcItems.tofuMetal, 2), 0.5F)
        ...
        forestry.api.apiculture.BeeManager.beeMutationFactory
            .createMutation(KINU, KINU, TFBeeGenomeManager.getTemplateMomen(), 12);
        forestry.api.apiculture.BeeManager.beeMutationFactory
            .createMutation(KINU, MOMEN, TFBeeGenomeManager.getTemplateKongo(), 5)
            .restrictBiomeType(TofuCraftCore.BIOME_TYPE_TOFU);
    }

    public static IAlleleBeeSpeciesCustom create(String name, TFBeeClassification classification, String binomial,
        boolean dominant, Color primary, Color secondary) {
        ...
        return forestry.api.apiculture.BeeManager.beeFactory.createSpecies(
            uid,
            dominant,
            "Tofunian",
            unlocalizedName,
